...
$blog_title = "R-devel NEWS";

# What's this blog's description (for outgoing RSS feed)?
$blog_description = "Daily updates to R-devel NEWS.";

# What's this blog's primary language (for outgoing RSS feed)?
$blog_language = "en";

# Where are this blog's entries kept?
$datadir = "/home/murdoch/blosxom/data";
...
$plugin_dir = "/home/murdoch/blosxom/plugins";
...
$url ||= url();
$url =~ s/^included:/https:/; # Fix for Server Side Includes (SSI)
$url =~ s!/$!!;
